...
5) Move to a warm dry environment and place in a level orientation with the X and Y IMU axes horizontal and the Z axis pointing down.
...
9) Run the xript file 'python process_sensor_caldata.py <full path name to .ulog file>
...
# fit X axis
coef_accel_0_x = np.polyfit(temp_rel,-sensor_accel_0['x'],3)
...
accel_0_x_resample = fit_coef_accel_0_x(temp_rel_resample)

# fit Y axis
coef_accel_0_y = np.polyfit(temp_rel,-sensor_accel_0['y'],3)
...
accel_0_y_resample = fit_coef_accel_0_y(temp_rel_resample)

# fit Z axis
coef_accel_0_z = np.polyfit(temp_rel,-(sensor_accel_0['z']+gravity),3)
...
accel_0_z_resample = fit_coef_accel_0_z(temp_rel_resample)
...
# draw plots
plt.subplot(3,1,1)
plt.plot(sensor_accel_0['temperature'],sensor_accel_0['x'],'b')
plt.plot(temp_resample,-accel_0_x_resample,'r')
...
# draw plots
plt.subplot(3,1,2)
plt.plot(sensor_accel_0['temperature'],sensor_accel_0['y'],'b')
plt.plot(temp_resample,-accel_0_y_resample,'r')
...
# draw plots
plt.subplot(3,1,3)
plt.plot(sensor_accel_0['temperature'],sensor_accel_0['z']+gravity,'b')
plt.plot(temp_resample,-accel_0_z_resample,'r')
...
# fit X axis
coef_accel_1_x = np.polyfit(temp_rel,-sensor_accel_1['x'],3)
...
accel_1_x_resample = fit_coef_accel_1_x(temp_rel_resample)

# fit Y axis
coef_accel_1_y = np.polyfit(temp_rel,-sensor_accel_1['y'],3)
...
accel_1_y_resample = fit_coef_accel_1_y(temp_rel_resample)

# fit Z axis
coef_accel_1_z = np.polyfit(temp_rel,-(sensor_accel_1['z']+gravity),3)
...
accel_1_z_resample = fit_coef_accel_1_z(temp_rel_resample)
...
# draw plots
plt.subplot(3,1,1)
plt.plot(sensor_accel_1['temperature'],sensor_accel_1['x'],'b')
plt.plot(temp_resample,-accel_1_x_resample,'r')
...
# draw plots
plt.subplot(3,1,2)
plt.plot(sensor_accel_1['temperature'],sensor_accel_1['y'],'b')
plt.plot(temp_resample,-accel_1_y_resample,'r')
plt.ylabel('Y bias (m/s/s)')
plt.xlabel('temperature (degC)')
plt.grid()
...
# draw plots
plt.subplot(3,1,3)
plt.plot(sensor_accel_1['temperature'],sensor_accel_1['z']+gravity,'b')
plt.plot(temp_resample,-accel_1_z_resample,'r')
plt.ylabel('Z bias (m/s/s)')
plt.xlabel('temperature (degC)')
plt.grid()
...
# fit X axis
coef_accel_2_x = np.polyfit(temp_rel,-sensor_accel_2['x'],3)
...
accel_2_x_resample = fit_coef_accel_2_x(temp_rel_resample)

# fit Y axis
coef_accel_2_y = np.polyfit(temp_rel,-sensor_accel_2['y'],3)
...
accel_2_y_resample = fit_coef_accel_2_y(temp_rel_resample)

# fit Z axis
coef_accel_2_z = np.polyfit(temp_rel,-(sensor_accel_2['z']+gravity),3)
...
accel_2_z_resample = fit_coef_accel_2_z(temp_rel_resample)
...
# draw plots
plt.subplot(3,1,1)
plt.plot(sensor_accel_2['temperature'],sensor_accel_2['x'],'b')
plt.plot(temp_resample,-accel_2_x_resample,'r')
...
# draw plots
plt.subplot(3,1,2)
plt.plot(sensor_accel_2['temperature'],sensor_accel_2['y'],'b')
plt.plot(temp_resample,-accel_2_y_resample,'r')
plt.ylabel('Y bias (m/s/s)')
plt.xlabel('temperature (degC)')
plt.grid()
...
# draw plots
plt.subplot(3,1,3)
plt.plot(sensor_accel_2['temperature'],sensor_accel_2['z']+gravity,'b')
plt.plot(temp_resample,-accel_2_z_resample,'r')
plt.ylabel('Z bias (m/s/s)')
plt.xlabel('temperature (degC)')
plt.grid()
